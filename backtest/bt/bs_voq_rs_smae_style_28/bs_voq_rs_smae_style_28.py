...
def init(context):
    ...
    context.rs_smae_style_28 = RotationStrategySmaEnergy(
    ...
    context.bs_voq_rs_smae_style_28 = BalanceStrategyVoQ(
        stock_strategy=context.rs_smae_style_28,
    ...
    context.bs_voq_rs_smae_style_28.get_vo()  # 初始化时生成波动率表
...
def handle_bar(context, bar_dict):
    ...
    context.bs_voq_rs_smae_style_28.bar_dict = bar_dict
    context.bs_voq_rs_smae_style_28.context = context
    context.bs_voq_rs_smae_style_28.transction(
        context.bs_voq_rs_smae_style_28.calculate_position())
