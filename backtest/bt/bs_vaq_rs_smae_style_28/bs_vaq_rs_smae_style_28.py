...
def init(context):
    ...
    context.bs_vaq_rs_smae_style_28 = BalanceStrategyVaQ(
...
def handle_bar(context, bar_dict):
    ...
    context.bs_vaq_rs_smae_style_28.bar_dict = bar_dict
    context.bs_vaq_rs_smae_style_28.context = context
    context.bs_vaq_rs_smae_style_28.transction(
        context.bs_vaq_rs_smae_style_28.calculate_position())
