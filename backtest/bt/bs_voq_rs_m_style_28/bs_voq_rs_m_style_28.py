...
def handle_bar(context, bar_dict):
    ...
    context.bs_test_rs_m_style_28.bar_dict = bar_dict
    context.bs_test_rs_m_style_28.context = context
    context.bs_test_rs_m_style_28.transction(
        context.bs_test_rs_m_style_28.calculate_position())
