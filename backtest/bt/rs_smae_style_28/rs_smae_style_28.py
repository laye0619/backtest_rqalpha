...
def handle_bar(context, bar_dict):
    ...
    context.rs_smae_style_28.today_total_portfolio_amount = context.stock_account.total_value
    context.rs_smae_style_28.bar_dict = bar_dict
    context.rs_smae_style_28.context = context
    context.rs_smae_style_28.transction(context.rs_smae_style_28.sort_target_list())
